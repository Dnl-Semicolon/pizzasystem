        ...
        <div class="p-4 sm:border-2 sm:border-gray-200 sm:border-dashed rounded-lg dark:border-gray-700 mt-14">
            ...
            <div class="mb-6">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl font-semibold text-gray-900 dark:text-gray-100">Pizzas</h1>
                        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Manage pizzas, filter, sort, and perform bulk actions.</p>
                    </div>
                    <div class="flex items-center gap-2">
                        {{-- REFRESH Button --}}
                        <x-secondary-link-button href="{{ url()->current() }}">Refresh</x-secondary-link-button>
                        {{-- C: CREATE PRODUCT Button --}}
                        <x-primary-link-button href="#">Create Pizza</x-primary-link-button>
                    </div>
                </div>
            </div>
