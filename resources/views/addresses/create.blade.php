                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('addresses.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="label" name="label" type="text" class="mt-1 block w-full" :value="old('label')" placeholder="e.g. Home, Office" />
