                        ...
                        @foreach ($crusts as $crust)
                            <tr class="border-b border-gray-200 dark:border-gray-700">
                                <td class="w-20 md:w-36 p-2">
                                    <img src="{{ asset($crust->image_url) }}" class="w-16 md:w-32 max-w-full max-h-full" alt="Placeholder">
                                </td>
                                <th class="px-4 py-2 border-gray-300 dark:border-gray-700">{{ $crust->id }}</th>
                                <td class="px-4 py-2 border-gray-300 dark:border-gray-700">{{ $crust->name }}</td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
