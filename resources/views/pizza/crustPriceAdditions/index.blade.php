                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <table class="min-w-full text-left border-collapse border-gray-400 dark:border-gray-600">
                        ...
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-2 border-gray-300 dark:border-gray-700">Crust</th>
                            <th scope="col" class="px-4 py-2 border-gray-300 dark:border-gray-700">Size</th>
                            <th scope="col" class="px-4 py-2 border-gray-300 dark:border-gray-700">Price Addition (RM)</th>
                        </tr>
                        </thead>
                        <tbody class="text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800">
                        @foreach ($crustPriceAdditions as $addition)
                            <tr class="border-b border-gray-200 dark:border-gray-700">
                                <th class="px-4 py-2 border-gray-300 dark:border-gray-700">{{ $addition->id }}</th>
                                ...
                                <td class="px-4 py-2 border-gray-300 dark:border-gray-700">
                                    {{ number_format($addition->price_addition, 2) }}
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
